...
def plot_stat_vs_wind(ax, data, x_col, y_col, style, label):
    ...
    ax.scatter(x, y_max, edgecolor=style['color'], color='none', marker='^')
    ax.scatter(x, y_min, edgecolor=style['color'], color='none', marker='v')
    ax.grid(linestyle =':', color = 'gray')

def plot_spanwise_comparison(stats_mapped, spanwise_channels, labels, colors, linestyles, sim_label, title_prefix="", show_extrema=False):
